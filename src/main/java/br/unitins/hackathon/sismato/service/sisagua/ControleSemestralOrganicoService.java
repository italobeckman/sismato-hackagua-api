...
public class ControleSemestralOrganicoService
        extends AbstractControleService<ControleSemestralOrganico, ControleSemestralOrganicoRepository>{

    @Inject
    ControleSemestralOrganicoRepository controleSemestralOrganicoRepository;

    @Override
    protected ControleSemestralOrganicoRepository getRepository() {
