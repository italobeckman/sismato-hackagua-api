...
public class ControleSemestralOrganicoResource {
    ...
    public ColetaAnualDTO findColetaAnualWithFilter(
        ...
        return controleSemestralOrganicoService.findColetaAnualWithFilter(filtros, page, pageSize);
    }
    ...
    public ColetaMensalDTO findColetaMensalWithFilter(
        ...
        return controleSemestralOrganicoService.findColetaMensalWithFilter(filtros, page, pageSize);
    }
}