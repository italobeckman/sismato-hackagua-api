...
public class ControleSemestralOutrosResource {
    ...
    public ColetaAnualDTO findColetaAnualWithFilter(
        ...
        return controleSemestralOutrosService.findColetaAnualWithFilter(filtros, page, pageSize);
    }
    ...
    public ColetaMensalDTO findColetaMensalWithFilter(
        ...
        return controleSemestralOutrosService.findColetaMensalWithFilter(filtros, page, pageSize);
    }
}